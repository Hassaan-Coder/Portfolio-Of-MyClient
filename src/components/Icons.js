...
export const GithubIcon = () => {
  const redirectToInstagram = () => {
    window.open(
      "https://www.instagram.com/notonlydesigners23/?igshid=Y2I2MzMwZWM3ZA==",
      "_blank"
    );
  };
  ...
  return (
    <button onClick={redirectToInstagram}>
      <FaInstagram size={24} style={{ color: "orange" }} />
    </button>
  );
};
export const BehanceI = () => {
  const redirectToInstagram = () => {
    window.open("https://www.behance.net/notonlydesigners23", "_blank");
  };

  return (
    <button onClick={redirectToInstagram}>
      <FaBehanceSquare size={24} style={{ color: "blue" }} />
    </button>
  );
};
...
export const LinkedInIcon = () => {
  const redirectToInstagram = () => {
    window.open(
      "https://www.linkedin.com/in/not-only-designers-58b7a3281/",
      "_blank"
    );
  };
  ...
  return (
    <button onClick={redirectToInstagram}>
      <BsLinkedin size={25} style={{ color: "lightblue" }} />
    </button>
  );
};
...
export const TwitterIcon = () => {
  const redirectToInstagram = () => {
    window.open(
      "https://www.facebook.com/profile.php?id=100093747795872&mibextid=LQQJ4d",
      "_blank"
    );
  };
  ...
  return (
    <button onClick={redirectToInstagram}>
      <BsFacebook size={25} style={{ color: "blue" }} />
    </button>
  );
};
